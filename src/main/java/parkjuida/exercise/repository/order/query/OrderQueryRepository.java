...
public class OrderQueryRepository {
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery(
                "select new parkjuida.exercise.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    private List<OrderQueryDto> findOrders() {
        return em.createQuery(
                "select new parkjuida.exercise.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address)" +
                        " from Order o" +
                        " join o.member m" +
    ...
    public List<OrderFlatDto> findAllByDtoFlat() {
        return em.createQuery(
                "select new parkjuida.exercise.repository.order.query.OrderFlatDto(" +
